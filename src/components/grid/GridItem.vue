...
export default {
  ...
  methods: {
    ...
    elementDown (e) {
      ...
      if (this.$el.contains(target)) {
        ...
        this.mouseClickPosition.mouseX = (e.touches ? e.touches[0].pageX : e.pageX) / this.zoom
        this.mouseClickPosition.mouseY = (e.touches ? e.touches[0].pageY : e.pageY) / this.zoom
    ...
    elementMove (e) {
      ...
      const tmpDeltaX = axis && axis !== 'y' ? mouseClickPosition.mouseX - (e.touches ? e.touches[0].pageX : e.pageX) / this.zoom : 0
      const tmpDeltaY = axis && axis !== 'x' ? mouseClickPosition.mouseY - (e.touches ? e.touches[0].pageY : e.pageY) / this.zoom : 0
  ...
  computed: {
    ...
    // 控制柄显示与否
    actualHandles () {
      return !this.resizable ? [] : ['tl', 'tm', 'tr', 'mr', 'br', 'bm', 'bl', 'ml', 'rot']
    },
    width () {
